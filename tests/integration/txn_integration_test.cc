...
TEST_CASE(
    ...
    const auto             init_txn{tm.begin_txn(txn::isolation_level_t::SNAPSHOT)};
    ...
    {
        std::jthread t0{[&] {
            const auto t1{tm.begin_txn(txn::isolation_level_t::SERIALIZABLE)};
        ...
        std::jthread t1{[&] {
            ...
            const auto t2{tm.begin_txn(txn::isolation_level_t::SERIALIZABLE)};
    ...
    {
        const auto             check_txn{tm.begin_txn(txn::isolation_level_t::SNAPSHOT)};
    ...
    {
        const auto t3{tm.begin_txn(txn::isolation_level_t::SERIALIZABLE)};
