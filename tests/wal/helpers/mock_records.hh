...
[[nodiscard]] auto write_begin_log(std::vector<std::byte>& buffer) -> wal::log_record;
[[nodiscard]] auto write_update_log(std::vector<std::byte>& buffer) -> wal::log_record;
[[nodiscard]] auto write_clear_log(std::vector<std::byte>& buffer) -> wal::log_record;
